<?php 
	...
	function login(){
		...
		if (count($errors) == 0) {
			...
			if (mysqli_num_rows($results) == 1) { // user found
				...
				elseif ($logged_in_user['User_Type'] == 'registrar') {
				...
				elseif ($logged_in_user['User_Type'] == 'non_teaching') {

					$_SESSION['user'] = $logged_in_user;
					$_SESSION['success']  = "You are now logged in";
					header('location: non_teaching/home.php');		  
				}
	...
	function isnon_teaching()
	{
		if (isset($_SESSION['user']) && $_SESSION['user']['User_Type'] == 'non_teaching' ) {
			return true;
		}else{
			return false;
		}
	...
	{
		if (isset($_SESSION['user']) && $_SESSION['user']['User_Type'] == 'registrar' ) {
			return true;
		}else{
			return false;
		}
